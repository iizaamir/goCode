...
const db = mongoose.connect(DB1,{ //To connect to db, 1st connection string 2nd options for deprication warnings
...
// const port = 3000 || process.env.PORT; //port should be coming from either environment or 4000
